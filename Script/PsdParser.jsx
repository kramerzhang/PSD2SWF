...
var typeList = 			["Image", "ScaleImage", "Label", "Button", "ComboBox", "Container", "DragBar", 
						"List", "RadioButton", "RadioButtonGroup", "ScrollBar", "Slider", "Stepper"];
						
var parserList = 		[parseImage, parseScaleImage, parseLabel, parseContainer, parseContainer, parseContainer, parseDragBar,
						parseList, parseContainer, parseContainer, parseContainer, parseContainer, parseContainer];
						
var generatorList = 	[generateImageStr, generateScaleImageStr, generateLabelStr, generateContainerStr, generateContainerStr, generateContainerStr, generateDragBarStr,
						generateListStr, generateContainerStr, generateContainerStr, generateContainerStr, generateContainerStr, generateContainerStr];
						
var validatorList = 	[imageValidator, scaleImageValidator, labelValidator, buttonValidator, comboBoxValidator, containerValidator, dragBarValidator, listValidator,
						radioButtonValidator, radioButtonGroupValidator, scrollBarValidator, sliderValidator, stepperValidator];
